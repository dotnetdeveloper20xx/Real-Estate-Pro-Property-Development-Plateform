...
/// <summary>
/// Handles retrieval of legal case summaries for a specific planning application.
...
/// </summary>
public sealed class GetLegalCaseSummaryForPlanningQueryHandler
    : IRequestHandler<GetLegalCaseSummaryForPlanningQuery, List<LegalCaseSummaryDto>>
{
    ...
    public GetLegalCaseSummaryForPlanningQueryHandler(IRepository<LegalCase> repository)
    {
        _repository = repository;
    }

    public async Task<List<LegalCaseSummaryDto>> Handle(
        GetLegalCaseSummaryForPlanningQuery request,
        CancellationToken cancellationToken)
    {
        var summaries = await _repository
            .Query()
            .AsNoTracking()
            .Where(c => c.PlanningApplicationId == request.PlanningApplicationId)
