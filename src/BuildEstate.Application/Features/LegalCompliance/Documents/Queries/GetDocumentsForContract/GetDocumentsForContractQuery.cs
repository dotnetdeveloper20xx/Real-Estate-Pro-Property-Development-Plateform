...
/// <summary>
/// Query to retrieve a paginated, filtered list of legal documents for a specific contract.
...
/// </summary>
public sealed record GetDocumentsForContractQuery : IRequest<PagedResult<LegalDocumentListItemDto>>
{
    /// <summary>The contract to retrieve documents for.</summary>
