...
/// <summary>
/// Validates the CreateCouncilContactCommand input fields.
/// </summary>
public sealed class CreateCouncilContactCommandValidator : AbstractValidator<CreateCouncilContactCommand>
{
    public CreateCouncilContactCommandValidator()
    {
