...
/**
 * Radio group form control component.
 *
 * Renders a group of DaisyUI radio buttons for single selection.
 * Extends BaseFormControl<string> and integrates with Angular Reactive Forms.
 *
 * Uses `role="radiogroup"` with `aria-labelledby` for accessibility.
 *
...
export class RadioGroupComponent extends BaseFormControl<string> {
