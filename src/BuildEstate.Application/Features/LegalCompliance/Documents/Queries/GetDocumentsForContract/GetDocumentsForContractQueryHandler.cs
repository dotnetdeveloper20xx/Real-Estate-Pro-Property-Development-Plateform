...
namespace BuildEstate.Application.Features.LegalCompliance.Documents.Queries.GetDocumentsForContract;

/// <summary>
/// Handles retrieval of a paginated, filtered list of documents for a contract.
...
/// </summary>
public sealed class GetDocumentsForContractQueryHandler
    : IRequestHandler<GetDocumentsForContractQuery, PagedResult<LegalDocumentListItemDto>>
{
    ...
    public GetDocumentsForContractQueryHandler(
    ...
    public async Task<PagedResult<LegalDocumentListItemDto>> Handle(
        GetDocumentsForContractQuery request,
