...
/// <summary>
/// Handles retrieval of a paginated, filtered, sorted, and searchable list of contracts.
...
public sealed class GetContractsQueryHandler
    : IRequestHandler<GetContractsQuery, PagedResult<ContractListItemDto>>
{
    ...
    public async Task<PagedResult<ContractListItemDto>> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return PagedResult<ContractListItemDto>.Create(items, totalCount, pageNumber, pageSize);
    }
