...
/**
 * Typed form interface for the Opportunity create/edit form.
 */
...
/**
 * Opportunity Create page — reactive form for creating a new land opportunity.
 *
 * Features:
  ...
  template: `
    <div class="p-6 max-w-3xl mx-auto">
      ...
      <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900">Create New Opportunity</h1>
        <p class="mt-1 text-sm text-gray-600">
          Capture a new land opportunity for evaluation. Complete the required fields below to add the opportunity to the pipeline.
        </p>
      </div>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="card bg-base-100 shadow-sm" novalidate>
        <div class="card-body space-y-5">
          ...
          <div class="card-actions justify-end pt-4 border-t border-base-200">
            <a routerLink="/land-acquisition/pipeline" class="btn btn-ghost">
              Cancel
            </a>
            <button
              type="submit"
...
export class OpportunityCreatePageComponent implements OnInit, HasUnsavedChanges {
  ...
  /** Typed reactive form for opportunity creation. */
  ...
  ngOnInit(): void {
    // Listen for successful creation to navigate back
    this.actions$
      .pipe(
  ...
  /**
   * Submit the form — dispatch the createOpportunity action.
   */
  onSubmit(): void {
    this.submitted = true;
